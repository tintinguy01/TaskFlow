    ...
    return (
        ...
        className={cn(
            ...
            active && "bg-primary/5 text-primary"
                ...
                {!!id && (
                    <div role="button" className="h-full rounded-sm
            ...
            {isSearch && (
                ...
                h-5 select-none items-center gap-1 rounder border bg-muted
                px-1.5 font-mono text-[12px] font-medium text-muted-foreground opacity-100">
            ...
            {!!id && (
                <div className="ml-auto flex items-center gap-x-2">
                    <DropdownMenu>
                        ...
                        align="start" side="right" forceMount>
