...
import { Calendar, ChevronsLeft, MenuIcon, Plus, PlusCircle, Search, Settings, Table, Trash } from "lucide-react";
        ...
        <>
            <aside ref={sidebarRef} className={cn(
                ...
                <div>
                    ...
                    isSearch onClick={search.onOpen} />
                    <Item label="Settings" icon={Settings}
                    onClick={settings.onOpen} />
                    <Item 
                    onClick={handleCreate} label="New Page" icon={PlusCircle} />
                    <Popover>
                ...
                <div className="mt-4">
                    ...
                    icon={Plus} label="Add a page" />
                </div>
                
                <div className="mt-4">
                <Item icon={Calendar} 
                label="Calendar" 
                onClick={() => {router.push("/documents/calendar")}} />
                </div>
            ...
            <div ref={navbarRef}
            className={cn(
                "absolute tio-0 z-[99999] left-60 w0[calc(100%-240px)]",
                isResetting && "transition-all ease-in-out duration-300",
